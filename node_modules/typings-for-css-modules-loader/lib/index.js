...
module.exports = function (input) {
  ...
  this.async = function () {
    return function (err, content) {
      ...
      var cssModuleKeys = Object.keys(_this.exec(content, _this.resource));
      ...
      if (!query.namedExport) {
        ...
        var _filterNonWordClasses2 = _slicedToArray(_filterNonWordClasses, 2);

        var cleanedDefinitions = _filterNonWordClasses2[0];
        var skippedDefinitions = _filterNonWordClasses2[1];
